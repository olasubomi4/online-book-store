...
function select4LatestBooksearch($conn)
{
	$row = array();
...
function select4LatestBooka($conn)
{
	$row = array();
	$query = "SELECT book_isbn, book_image FROM books ORDER BY book_isbn DESC";
	$result = mysqli_query($conn, $query);
...
function select4LatestBook2($conn)
{
	$row = array();
	$query = "SELECT book_isbn, book_image FROM cs ORDER BY downloads DESC";
	$result = mysqli_query($conn, $query);
	if (!$result) {
		echo "Can't retrieve data " . mysqli_error($conn);
		exit;
...
function select4LatestBook3($conn)
{
	$row = array();
	$query = "SELECT book_isbn, book_image FROM ct ORDER BY downloads DESC";
	$result = mysqli_query($conn, $query);
	if (!$result) {
		echo "Can't retrieve data " . mysqli_error($conn);
		exit;
...
function select4LatestBook4($conn)
{
	$row = array();
	$query = "SELECT book_isbn, book_image FROM se ORDER BY downloads DESC";
	$result = mysqli_query($conn, $query);
	if (!$result) {
		echo "Can't retrieve data " . mysqli_error($conn);
		exit;
...
function select4LatestBook5($conn)
{
	$row = array();
	$query = "SELECT book_isbn, book_image FROM cis ORDER BY downloads DESC";
	$result = mysqli_query($conn, $query);
	if (!$result) {
		echo "Can't retrieve data " . mysqli_error($conn);
		exit;
	...
	function getBookByIsbn($conn, $isbn){
		$query = "SELECT book_title, book_author, book_price FROM cs WHERE book_isbn = '$isbn'";
		$result = mysqli_query($conn, $query);
		if(!$result){
			echo "Can't retrieve data " . mysqli_error($conn);
			exit;
